...
<html class="x-admin-sm">
    ...
    $(function(){
    	...
    	$.ajax({
    		type:"GET",
    		url:'BAndroidAppMessage/memberedit',
    		data:{"nid":${param.nid}},
    		dataType:"json",
    		async: true,
    		success:function(rs){	
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="${pageContext.request.contextPath}/BAndroidAppMessage/updatemessageByid" id="formedit"  method="get">
