   $(function(){
    ...
    //获取浏览器
     getBrowerInfo();
    $("#info_os").html(os.name);
  
    $.ajax({
    	type:"post",
    	url:"SAC/getAllLeaveMessage",
    	dataType:"json",
    	async:true,
    	success:function(rs){
    		$("#leaveMessage").html(rs);
    	}
    })
...
//						console.log(e.message);
				...
				if (Browser.client.name == undefined || Browser.client.name=="") {
				   ...
				   $("#info_browser").html(Browser.client.name + " " + Browser.client.version);
